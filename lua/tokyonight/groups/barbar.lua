...
function M.get(c)
  -- stylua: ignore
  return {
    BufferAlternate        = { bg = c.fg_dim4, fg = c.fg },
    BufferAlternateADDED   = { bg = c.fg_dim4, fg = c.git.add },
    BufferAlternateCHANGED = { bg = c.fg_dim4, fg = c.git.change },
    BufferAlternateDELETED = { bg = c.fg_dim4, fg = c.git.delete },
    BufferAlternateERROR   = { bg = c.fg_dim4, fg = c.error },
    BufferAlternateHINT    = { bg = c.fg_dim4, fg = c.hint },
    BufferAlternateINFO    = { bg = c.fg_dim4, fg = c.info },
    BufferAlternateIndex   = { bg = c.fg_dim4, fg = c.info },
    BufferAlternateMod     = { bg = c.fg_dim4, fg = c.warning },
    BufferAlternateSign    = { bg = c.fg_dim4, fg = c.info },
    BufferAlternateTarget  = { bg = c.fg_dim4, fg = c.fg9 },
    BufferAlternateWARN    = { bg = c.fg_dim4, fg = c.warning },
    ...
    BufferCurrentTarget    = { bg = c.bg, fg = c.fg9 },
    BufferCurrentWARN      = { bg = c.bg, fg = c.warning },
    BufferInactive         = { bg = Util.blend_bg(c.bg_highlight, 0.4), fg = Util.blend_bg(c.fg_dim2, 0.8) },
    ...
    BufferInactiveIndex    = { bg = Util.blend_bg(c.bg_highlight, 0.4), fg = c.fg_dim2 },
    ...
    BufferInactiveTarget   = { bg = Util.blend_bg(c.bg_highlight, 0.4), fg = c.fg9 },
    BufferInactiveWARN     = { bg = Util.blend_bg(c.bg_highlight, 0.4), fg = Util.blend_bg(c.warning, 0.8) },
    BufferOffset           = { bg = c.bg_statusline, fg = c.fg_dim2 },
    BufferTabpageFill      = { bg = Util.blend_bg(c.bg_highlight, 0.8), fg = c.fg_dim2 },
    ...
    BufferVisibleTarget    = { bg = c.bg_statusline, fg = c.fg9 },
